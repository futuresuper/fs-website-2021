<script>
  ...
  onMount(() => {
    ...
    const observerArrow = new IntersectionObserver((entries) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          let isModal = entry.target.classList.contains(
            "journey-section__content--form"
          );
          if (timer) {
            clearTimeout(timer);
            timer = null;
    ...
    const balanceSectionHeight =
      document.querySelector(".balance-section").clientHeight;
    ...
    scrollSection.addEventListener("scroll", function (e) {
      ...
      let scale = Math.max(
        0.028,
        1 - (e.target.scrollTop - balanceSection.offsetTop) / 400
      );
      ...
      const firstBigCircle = document.querySelector(
        ".amount-section__circle--1"
      );
      const secondBigCircle = document.querySelector(
        ".amount-section__circle--2 > div"
      );
      const thirdBigCircle = document.querySelector(
        ".amount-section__circle--3 > div"
      );

      const scrollSectionContentLast =
        document.getElementById("journeySectionEnd");

      const explainSectionFirst = document.querySelector(
        ".explain-section--first"
      );
      const explainSectionSecond = document.querySelector(
        ".explain-section--second"
      );
      explainSectionLast = document.querySelector(".explain-section--last");

      const counterHundreds = document.querySelector(
        ".counter__sets--hundreds"
      );
      ...
      if (
        e.target.scrollTop >=
        balanceSection.offsetTop - window.innerHeight * 0.9
      ) {
      ...
      if (e.target.scrollTop >= balanceSection.offsetTop + 10) {
        ...
        circle.style.top = `${
          balanceSectionHeight - circle.clientHeight - 200
        }px`;
        if (scale <= 0.3) {
      ...
      if (e.target.scrollTop >= amountSection.offsetTop + 10 && top < 20) {
        ...
        firstBigCircle.style.transform = `translateX(-50%) scale(${
          scaleOne <= 16 ? scaleOne : scaleTwo
        })  translateZ(0)`;
      ...
      let snapSectionWithDots =
        e.target.scrollTop > dotGrid.offsetTop &&
        e.target.scrollTop <=
          dotGrid.clientHeight + dotGrid.offsetTop + dotGrid2.clientHeight;
      let snapSectionBalance =
        e.target.scrollTop > balanceSection.offsetTop - balanceSectionHeight &&
        e.target.scrollTop <= balanceSection.offsetTop + 5;
      let snapSectionExplainIcons =
        e.target.scrollTop >= explainSectionFirst.offsetTop &&
        e.target.scrollTop <= balanceSection.offsetTop - balanceSectionHeight;

      // Blocks with dots to snap to center when scrolling
      if (
        snapSectionWithDots ||
        snapSectionExplainIcons ||
        snapSectionBalance
      ) {
        scrollSection.classList.add("snap");
      } else {
...
<div class="bg-main">
  ...
  <div class="scroll-section">
    <section class="hero-section container container--width bg">
      <h1 class="hero-section__heading center">
        Welcome <br />to the<br /> movement
      </h1>

      <div class="hero-section__content">
        <p>
          By joining Future Super, you’re also joining a movement! We’re
          fighting for a future free from climate change and inequality.
        </p>
        <p>
          It’s easy to feel powerless when we think about the big issues facing
          the world, but the truth is - money has power.
        </p>
        <p>
          What does the power of money look like? Well, let's think about some
          numbers...
        </p>
      </div>
      ...
      <div class="">
        <div class="explain-section explain-section--first">
          <div class="explain-section__content hasArrow">
            <div class="explain-section__content--icon">
              ...
              >
                <path
                  d="M3 12L12 5L21 12V23C21 23.5304 20.7893 24.0391 20.4142 24.4142C20.0391 24.7893 19.5304 25 19 25H5C4.46957 25 3.96086 24.7893 3.58579 24.4142C3.21071 24.0391 3 23.5304 3 23V12Z"
                  stroke="#3DFA52"
                  stroke-width="2"
            ...
            <div class=" ">
              ...
              <p class="explain-section__content--text">
                It’s the median house price in Sydney
              </p>
            </div>

            <svg
              on:click={() => scrollToNextSection("#explainSection2")}
              class="down-arrow"
              width="44"
              height="44"
              viewBox="0 0 44 44"
            ...
            >
              <g id="Arrow Down">
                <path
                  ...
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M21.0831 32.6992L16.2743 27.1759L14.8916 28.3798L21.3083 35.7498L22.691 35.7498L29.1076 28.3798L27.7249 27.1759L22.9165 32.6988L22.9165 8.25269L21.0831 8.25269L21.0831 32.6992Z"
                  fill="#3DFA52"
                />
              </g>
            </svg>
        ...
        <div
          id="explainSection2"
          class="explain-section explain-section--second"
        >
          <div class="explain-section__content hasArrow">
            <div class="explain-section__content--icon">
              <svg
            ...
            <div class="">
              <p class="explain-section__content--heading">$1.3 million</p>
              <p class="explain-section__content--text">
                It’s about the same amount that subsidies to fossil fuel
                companies cost Australia <strong>every hour.</strong>
              </p>
            </div>

            <svg
              on:click={() => scrollToNextSection("#explainSection3")}
              class="down-arrow"
              width="44"
              height="44"
              viewBox="0 0 44 44"
        ...
        <div id="explainSection3" class="explain-section explain-section--last">
          <div class="explain-section__content hasArrow">
            ...
            <div class="">
              <p class="explain-section__content--heading">$1.3 million</p>
              <p class="explain-section__content--text">
                It’s paid 24 hours a day, 7 days a week. A total of...
              </p>
            </div>

            <svg
              on:click={() => scrollToNextSection("#bigCircle")}
              class="down-arrow"
              width="44"
              height="44"
              viewBox="0 0 44 44"
    ...
    <section class="balance-section hasArrow container container--width bg">
        ...
        <div class="balance-section__balance center">
          ...
          <p class="balance-section__balance--description">
            <span class="circle-text"
              >Spent on subsidies to fossil fuel companies <strong
                >every week.</strong
              ></span
            >
          </p>
      ...
      <svg
        on:click={() => scrollToNextSection("#journeySection1")}
        class="down-arrow"
        width="44"
        height="44"
        viewBox="0 0 44 44"
    ...
    <div class="journey-section bg">
      <div
        id="journeySection1"
        class="journey-section__content journey-section__content--top"
      >
        <div class="active-dot top-dot" />
        <div
          class="journey-section__block journey-section__block--top hasArrow"
        >
          <p>
            That's a lot of money, right? But compared to the <span
              class="highlighted--white"><strong>$3.4 trillion</strong></span
            >
            Australians have in their super,
            <span class="highlighted">$200 million</span> looks tiny. And we can
            use that super to fight back climate change.
          </p>
          <svg
            on:click={() => scrollToNextSection("#journeySection2")}
            class="down-arrow"
            width="44"
            height="44"
            viewBox="0 0 44 44"
      ...
      <div id="journeySection2" class="journey-section__content">
        <div
          class="journey-section__block journey-section__block--all hasArrow"
        >
          <p>
            First up, let’s have a think about what <span
              class="highlighted--white"><strong>$3.4 trillion</strong></span
            > could do!
          </p>
          <svg
            on:click={() => scrollToNextSection("#journeySection3")}
            class="down-arrow"
            width="44"
            height="44"
            viewBox="0 0 44 44"
      ...
      <div
        id="journeySection3"
        class="journey-section__content journey-section__content--form hasArrow"
      >
        <div class="question-modal">
          <div class="question-modal__info">
            <div class="question-modal__badge">Let's guess</div>
            <p
              class="question-modal__label {!guess
                ? 'question-modal__label--green'
                : ''}"
            >
              Select Your Answer
            </p>
          </div>
          <p class="question-modal__heading">
            What percentage of $3.4 trillion is needed to switch Australia to
            100% renewable energy?
          </p>
          <div class="question-modal__answers">
            {#if !guess || guess !== 1}
              <div
                class="question-modal__answers--block"
                on:click={() => chooseGuess(1)}
              >
                7.2 %
              </div>
              <div
                class="question-modal__answers--block {guess === 2
                  ? 'question-modal__answers--block-selected'
                  : ''}"
                on:click={() => chooseGuess(2)}
              >
                {#if guess !== 2}
                  18.9%
                {:else}
              ...
              <div
                class="question-modal__answers--block {guess === 3
                  ? 'question-modal__answers--block-selected'
                  : ''}"
                on:click={() => chooseGuess(3)}
              >
                {#if guess !== 3}
                  44.1%
                {:else}
        ...
        <svg
          on:click={() => scrollToNextSection("#journeySection3-5")}
          class="down-arrow"
          width="44"
          height="44"
          viewBox="0 0 44 44"
      ...
      <div
        id="journeySection3-5"
        class="journey-section__content {guess && guess === 1
          ? 'journey-section__content--right'
          : 'journey-section__content--wrong'}"
      >
        <section
          class="journey-section__block journey-section__block--all hasArrow"
        >
          {#if guess && guess === 1}
            <p>
              Yep, that’s right! Here’s what <span class="highlighted"
                >7.2%</span
              > of Australia’s pool of super looks like.
            </p>
          {:else}
            <p>
              Good news, we only need <span class="highlighted">7.2%</span> of $3.4
              trillion. Here’s what that looks like.
            </p>
          {/if}

          <svg
            on:click={() => scrollToNextSection("#journeySection4")}
            class="down-arrow"
            width="44"
            height="44"
            viewBox="0 0 44 44"
        ...
        <div class="active-dot-set">
          {#each Array(firstActiveSet) as _, index (index)}
            <div
              style="transition-delay: {index * 1.5}ms"
              class="active-dot hidden"
            />
          {/each}
        </div>
      </div>
      ...
      <div id="journeySection4" class="journey-section__content">
        <section class="journey-section__block hasArrow">
          <p>
            If we wanted to do even better than 100% renewable energy, and
            decarbonise the entire Australian economy - including transitioning
            transport and industry away from fossil fuels - the bill would be
            bigger, but maybe not by as much as you think.
          </p>

          <svg
            on:click={() => scrollToNextSection("#journeySection5")}
            class="down-arrow"
            width="44"
            height="44"
            viewBox="0 0 44 44"
      ...
      <div
        id="journeySection5"
        class="journey-section__content {guess && guess === 1
          ? 'journey-section__content--amount-more'
          : 'journey-section__content--amount-more-wrong'}"
      >
        <section
          class="journey-section__block journey-section__block--2 hasArrow"
        >
          <p>
            It would take about 9.5% of that $3.4 trillion. Just <span
              class="highlighted">2.3%</span
            > more.
          </p>

          <svg
            on:click={() => scrollToNextSection("#journeySection6")}
            class="down-arrow"
            width="44"
            height="44"
            viewBox="0 0 44 44"
        ...
        <div class="active-dot-set">
          {#each Array(secondActiveSet) as _, index (index)}
            <div
              style="transition-delay: {index * 1}ms"
              class="active-dot hidden"
            />
          {/each}
        </div>
      ...
      <div id="journeySection6" class="journey-section__content">
        ...
        >
          <p>
            For decades now, climate activists have been fighting to get
            institutions all over the world - including super funds - to divest.
          </p>

          <svg
            on:click={() => scrollToNextSection("#journeySection7")}
            class="down-arrow"
            width="44"
            height="44"
            viewBox="0 0 44 44"
      ...
      <div id="journeySection7" class="journey-section__content">
        ...
        >
          <p>
            What is divestment? It’s refusing to invest in the fossil fuel
            companies that are causing catastrophic climate change.
          </p>

          <svg
            on:click={() => scrollToNextSection("#journeySection8")}
            class="down-arrow"
            width="44"
            height="44"
            viewBox="0 0 44 44"
      ...
      <div id="journeySection8" class="journey-section__content">
        ...
        >
          <p>
            In Australia, some super funds invest in fossil fuel companies but
            say they’ll pressure them to behave responsibly. But at Future
            Super, we screen out fossil fuel companies from what we call our
            “investable universe”.
          </p>

          <svg
            on:click={() => scrollToNextSection("#journeySection9")}
            class="down-arrow"
            width="44"
            height="44"
            viewBox="0 0 44 44"
      ...
      <div id="journeySection9" class="journey-section__content">
        ...
        >
          ...
          <svg
            on:click={() => scrollToNextSection("#journeySection10")}
            class="down-arrow"
            width="44"
            height="44"
            viewBox="0 0 44 44"
      ...
      <div id="journeySection10" class="journey-section__content">
        ...
        >
          <p>
            After so much scrolling, you might have forgotten - all these tiny
            dots are still representing that <span class="highlighted--white"
              ><strong>$3.4 trillion</strong></span
            > pool of super. And yep, that’s a lot of dots!
          </p>

          <svg
            on:click={() => scrollToNextSection("#journeySection11")}
            class="down-arrow"
            width="44"
            height="44"
            viewBox="0 0 44 44"
      ...
      <div id="journeySection11" class="journey-section__content">
        ...
        >
          <p>
            But <span class="highlighted--white"
              ><strong>$3.4 trillion</strong></span
            > is about to look like nothing. Wait until you see how big the divestment
            movement is....
          </p>

          <svg
            on:click={() => scrollToNextSection("#journeySection12")}
            class="down-arrow"
            width="44"
            height="44"
            viewBox="0 0 44 44"
    ...
    <div class="journey-section-2 smaller-dots-bg bg">
      <div id="journeySection12" class="journey-section__content">
        ...
        >
          <p>
            The Divestment Database keeps track of all the institutions - like
            universities, charities and international pension funds - that have
            committed to divesting fossil fuels.
          </p>

          <svg
            on:click={() => scrollToNextSection("#journeySection13")}
            class="down-arrow"
            width="44"
            height="44"
            viewBox="0 0 44 44"
      ...
      <div id="journeySection13" class="journey-section__content">
        ...
        >
          <p>
            To offer some perspective - the wealth of Elon Musk, Jeff Bezos and
            Bill Gates combined is about <span class="highlighted"
              >$600 billion</span
            >, that’s those green dots.
          </p>

          <svg
            on:click={() => scrollToNextSection("#journeySection14")}
            class="down-arrow"
            width="44"
            height="44"
            viewBox="0 0 44 44"
        ...
        <div
          class="active-dot-set active-dot-set__smaller active-dot-set__smaller--1"
        >
          {#each Array(thirdActiveSet) as _, index (index)}
            <div
              style="transition-delay: {index * 1}ms"
              class="active-dot hidden active-dot__smaller"
            />
          {/each}
        </div>
      </div>
      ...
      <div id="journeySection14" class="journey-section__content">
        ...
        >
          <p>
            What does the fortune of the world’s richest man look like? Here’s
            Bernard Arnault’s <span class="highlighted">$316 billion.</span>
          </p>
          <svg
            on:click={() => scrollToNextSection("#journeySection15")}
            class="down-arrow"
            width="44"
            height="44"
            viewBox="0 0 44 44"
        ...
        <div
          class="active-dot-set active-dot-set__smaller active-dot-set__smaller--2"
        >
      ...
      <div id="journeySection15" class="journey-section__content">
        ...
        >
          <p>
            You’re probably starting to wonder... what do all those tiny dots
            add up to?
          </p>

          <svg
            on:click={() => scrollToNextSection("#journeySectionEnd")}
            class="down-arrow"
            width="44"
            height="44"
            viewBox="0 0 44 44"
    ...
    <div class="container container--width p-0 overflow-x-clip">
      <section
        id="amountSection"
        class="amount-section journey-section__block--all smallest-dots-bg"
      >
        <div class="amount-section__circle amount-section__circle--1">
          <div class="amount-section__amount center">
            <p
              class="amount-section__amount--heading amount-section__amount--heading-1"
            >
              $60<br /> trillion
            </p>
            <p
              class="amount-section__amount--description amount-section__amount--description-1"
            >
              That's how big the divestment movement is!
            </p>
          </div>
          ...
          <div class="amount-section__circle amount-section__circle--2">
            <div class="amount-section__amount center">
              ...
              <p class="amount-section__amount--description">
                Australia’s collective super savings.
              </p>
            </div>
          </div>
          ...
          <div class="amount-section__circle amount-section__circle--3">
            <div class="amount-section__amount center">
              ...
              <p class="amount-section__amount--description">
                Could 100% fund Australia’s transition to <strong
                  >renewable energy AND decarbonise transport</strong
                > and industry.
              </p>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="block-quote">
          <p class="block-quote__content">
            How you invest matters. You might feel like a tiny dot, but you’re
            part of something huge.
          </p>
        </div>
        <p>We hope this story has got you thinking about the power of a $.</p>
        <p>
          After all, just 7.2% of Australia’s combined super savings could
          transition us to 100% renewable energy.
        </p>
        <p>
          When you put it that way, making big changes doesn’t seem so hard!
        </p>
      </div>
    </section>
    ...
    <section class="download-section container--width">
      <div class="download-section__action--wrapper">
        <div class="download-section__action">
          <p class="download-section__heading">
            Download the <span class="highlighted">Future Super App</span> to learn
            more about the impact your money is having!
          </p>
          ...
          <div class="download-section__images">
            ...
            <div class="download-section__actions">
              <div class="download-section__actions--buttons">
                <a
                  href="https://apps.apple.com/au/app/future-super/id1620110464"
                  class="download-section__action--button {appleDevice
                    ? ''
                    : 'download-section__action--button-hide'}"
                  target="_blank"
                >
                  <img
                ...
                <a
                  href="https://play.google.com/store/apps/details?id=au.com.futuresuper.app&pli=1"
                  class="download-section__action--button {appleDevice
                    ? 'download-section__action--button-hide'
                    : ''}"
                  target="_blank"
              ...
              <div class="download-section__actions--qr">
                <img src="/images/app-download-qr.svg" alt="QR code" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container container--width download-section__sources">
        ...
        <ul class="download-section__sources--list">
          <li>
            Sydney’s median house price from <a
              href="https://www.domain.com.au/news/then-and-now-this-time-series-shows-how-much-property-prices-have-changed-in-your-capital-city-in-two-years-1214754/"
              target="_blank">Domain research</a
            >.
          </li>
          <li>
            The hourly cost of fossil fuel subsidies calculated based on <a
              href="https://australiainstitute.org.au/post/australian-fossil-fuel-subsidies-surge-to-11-6-billion-in-2021-22/"
              target="_blank">Australia Institute</a
            > research.
          </li>
          <li>
            $3.4 trillion size of super based on <a
              href="https://www.apra.gov.au/news-and-publications/apra-releases-superannuation-statistics-for-march-2023"
              target="_blank">APRA data</a
            > from 2022 and 2023.
          </li>
          <li>
            Statistics on what percentage of superannuation it would take to
            fund the transition to renewable energy from <a
              href="https://www.uts.edu.au/isf/news/supercharging-road-100-clean-energy"
              target="_blank">UTS research, funded by Future Super</a
            >.
          </li>
          <li>
            Find out more about <a
              href="https://www.futuresuper.com.au/how-we-invest/"
              target="_blank">how Future Super screens</a
            > investments and what we invest in.
          </li>
          <li>
            Check out the <a
              href="https://divestmentdatabase.org/"
              target="_blank">Divestment Database</a
            >. The database tracks declared commitments to divestment. It’s not
            an indication of the amount actually divested from fossil fuels
            already, as investors will be at different stages of divestment. It
            also may omit some divestment commitments.
          </li>
          <li>
            Wealth of Bernard Arnault, Jeff Bezos, Elon Musk and Bill Gates from <a
              href="https://www.forbes.com/billionaires/"
              target="_blank">Forbes</a
            > on 5 July 2023.
          </li>
          <li>
            Value of Apple shares (market c ap) from <a
      ...
      <div class="container container--width download-section__disclaimer">
        ...
        <p>
          ...
          You should consider whether Future Super’s products are right for your
          individual objectives and needs and seek personal financial advice.
          Before making a decision to acquire, hold or continue to hold an
          interest in Future Super, please read the PDS and check our Target
          Market Determination (TMD) available at <a
            href="/documents-and-forms/"
            target="_blank">Documents and Forms | Future Super</a
        ...
        <p>
          ...
          (ABN 45 960 194 277; RSE Registration R1072914). The Trustee does not
          in any way endorse, warrant or accept responsibility for any services
          provided by the Promoter in its own right or directly to members or
          prospective members. Learn more about our Trustee including their
          Privacy Statement here. The Fund is administered by APEX
          Superannuation (Australia) Pty Ltd (ABN 28 081 966 243; AFSL 238507).
          Insurance cover is provided to eligible members by AIA Australia
          Limited (ABN 79 004 837 861; AFSL 230043).
        </p>

        <p>
          The dots in this article represent the scale of super and money in the
          divestment movement. They have been designed to be an accurate
          representation but on some devices there may be a small margin of
          error.
        </p>
      </div>
    </section>
  ...
  .journey-section-2 {
    ...
    &:global(.animate) {
      ...
      background-image: radial-gradient(#424242 1.3px, transparent 1px),
        radial-gradient(#424242 1.3px, transparent 2px);
