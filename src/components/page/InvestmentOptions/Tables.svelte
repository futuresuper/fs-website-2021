...
<div class="container tables">
  ...
  <p class="disclaimer">
    * Read our <a href="/pds">Product Disclosure Statement</a>
    ...
    for details on how fees apply to your Future Super account. The fees shown above
    are the total Investment Fees, Administration Fees and Indirect Cost Ratio payable
    for each of our investment options. Other fees and costs may apply to your account.
    There's no dollar-based admin fee when your balance is below $6,000. ^ Returns
    provided are after investment fees, percentage-based administration fees and
    taxes but before dollar-based administration fees have been taken out. Returns
    for periods of greater than one year are on a per annum compound basis. Return
    of capital and the performance of your investment in the Fund are not guaranteed.
